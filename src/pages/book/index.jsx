...
import { Button, Divider, Input, Popover, Rate, Skeleton } from "antd";
                    ...
                    isLoading === false ?
                        <div>
                            ...
                            <div style={{
                                ...
                                {quantity === 1 && quantity > 0 && quantity <= data.quantity ?
                                    <div>
                            ...
                            <div className="button">
                                ...
                                <div>
                                    <Button className="button-add">Thêm vào giỏ</Button>
                                </div>
                            </div>
                        </div> :
                        <div>
